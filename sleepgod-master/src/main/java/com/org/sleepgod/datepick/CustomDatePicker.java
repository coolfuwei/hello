package com.org.sleepgod.datepick;
...
public class CustomDatePicker {
    ...
    /**
     * http://blog.csdn.net/liuwan1992/article/details/52701475
     * 定义结果回调接口
     */
    public interface ResultHandler {
        void handle(String time, String tag);
    }
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.CHINA);
                if(handler != null) {
                    handler.handle(sdf.format(selectedCalender.getTime()),tag);
                }
                datePickerDialog.dismiss();
            }
        });
    ...
    public void show(String time,String tag) {
        this.tag = tag;
        if (canAccess) {
